...
public class RhineMod implements EditCardsSubscriber, EditCharactersSubscriber, EditKeywordsSubscriber, EditRelicsSubscriber, EditStringsSubscriber, PostBattleSubscriber, PostInitializeSubscriber, PostDungeonInitializeSubscriber, AddCustomModeModsSubscriber, OnStartBattleSubscriber, OnPlayerLoseBlockSubscriber, RelicGetSubscriber {
    ...
    public void initializeMonsters() {
        ...
        addMonster("R PowerArmor", names[7],  () -> new MonsterGroup(new AbstractMonster[] {new R31HeavyPowerArmor(-300.F, 0.0F), new R11AssaultPowerArmor(0.0F, 0.0F)}));
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new FallenLeavesOfFourSeasons(), RHINE_MATTE);
        ...
        BaseMod.addRelicToCustomPool(new BottleOfMemories(), RHINE_MATTE);
    ...
    public void receiveEditStrings() {
        ...
        String tutorialStrings = Gdx.files.internal("resources/rhinemod/strings/" + lang + "/tutorials.json").readString(String.valueOf(StandardCharsets.UTF_8));
