...
public class RedShiftExperiment extends AbstractRhineCard {
    public static final String ID = "rhinemod:RedShiftExperiment";
    public static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG = "resources/rhinemod/images/cards/RedShiftExperiment.png";
