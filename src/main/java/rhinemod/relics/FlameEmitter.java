...
public class FlameEmitter extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("resources/rhinemod/images/relics/FlameEmitter.png");
    public static final Texture IMG_OUTLINE = new Texture("resources/rhinemod/images/relics/FlameEmitter_p.png");
