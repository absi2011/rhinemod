...
public class ThreeDimensionArtDisplay extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("resources/rhinemod/images/relics/3DArtDisplay.png");
    public static final Texture IMG_OUTLINE = new Texture("resources/rhinemod/images/relics/3DArtDisplay.png");
