...
public class LoneTrail extends CustomRelic {
    ...
    public static final Texture IMG = new Texture("images/relics/LoneTrail.png");
    public static final Texture IMG_OUTLINE = new Texture("images/relics/LoneTrail_p.png");
    public LoneTrail() {
