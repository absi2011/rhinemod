...
public class AddStunTag extends AbstractRhinePower {
    ...
    public AddStunTag(AbstractCreature owner, int amount) {
        ...
        this.counter = amount;
        this.amount = amount;
        region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/rhinemod/images/powers/AddStunTag 84.png"), 0, 0, 84, 84);
        region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("resources/rhinemod/images/powers/AddStunTag 32.png"), 0, 0, 32, 32);
        updateDescription();
        priority = 99999999;
    }
