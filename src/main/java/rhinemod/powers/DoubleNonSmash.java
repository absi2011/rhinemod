...
public class DoubleNonSmash extends AbstractPower {
    public static final String POWER_ID = "rhinemod:DoubleNonSmash";
    public static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String NotTrigger = "rhinemod:Double This Damage!";
    public DoubleNonSmash(AbstractCreature owner) {
        this.ID = POWER_ID;
        this.name = NAME;
